...
// SCENE 3: Memory Gallery - Galeri Kenangan Spesial (SEDERHANA DULU)
function MemoryGallery({ name, onNext }) {
  ...
  const memories = [
    {
      ...
      date: "Momen Pertama",
      description: "Saat pertama kali kenal",
      icon: "💖",
      ...
      contents: [
        {
          ...
          details: "Saat mata kita pertama kali bertemu"
        }
      ]
    },
    {
      ...
      date: "Momen Bahagia",
      description: "Saat-saat tertawa bersama",
      icon: "😂",
      ...
      contents: [
        {
          ...
          details: "Tawamu adalah musik terindah"
        }
      ]
    },
    {
      ...
      contents: [
        {
          ...
          details: "Di saat sulit maupun senang"
        }
      ]
    }
  ];
  ...
  const selectedMemoryItem = memories.find(m => m.id === selectedMemory);
  ...
  return (
    <div className="h-full relative">
      <motion.div
        ...
        animate={{ opacity: 1 }}
        exit={{ opacity: 0 }}
        className="h-full flex flex-col bg-gradient-to-b from-pink-50 via-rose-50 to-purple-50 p-6"
      >
        {/* Header */}
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 mt-2">Koleksi momen indah untukmu</p>
        </div>
        ...
        <div className="text-center mt-8">
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            onClick={onNext}
            className="bg-gradient-to-r from-pink-500 to-purple-500 text-white px-8 py-3 rounded-full font-bold shadow-lg"
          >
            Lanjutkan Ke Pesan Spesial →
          </motion.button>
        </div>
      </motion.div>
        ...
        {isPopupOpen && selectedMemoryItem && (
          ...
          >
            ...
            >
              ...
              >
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent">
                  <div className="absolute bottom-0 left-0 right-0 p-6">
                    <h3 className="text-2xl font-bold text-white">{selectedMemoryItem.title}</h3>
              ...
              {/* Popup Content */}
              <div className="p-6">
                <p className="text-gray-700 mb-6">{selectedMemoryItem.description}</p>
                
                {selectedMemoryItem.contents.map((content) => (
                  <div key={content.id} className="bg-gray-50 rounded-xl p-4 mb-4">
                    <h4 className="font-bold text-gray-800 mb-2">{content.title}</h4>
                    <p className="text-gray-600 mb-2 italic">"{content.caption}"</p>
