...
function BirthdayReveal({ name, next }) {
  return (
    <div className="h-full flex flex-col items-center justify-center p-4 bg-gradient-to-b from-pink-50 to-purple-50" onClick={next}>
      <h1 className="text-5xl font-bold text-pink-600 mb-4">🎂 Happy Birthday! 🎂</h1>
      <p className="text-2xl text-gray-700 mb-8">Untuk {name || "kamu"} di usia ke-19</p>
      <p className="text-gray-600">Tap untuk melanjutkan</p>
    </div>
  );
}
